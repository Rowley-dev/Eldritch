...
import org.rsmod.content.items.jewellery.amulet_of_glory.configs.AMULET_OF_GLORY_LOCATIONS
...
class AmuletOfGlory @Inject constructor(private val worldRepo: WorldRepository) : PluginScript() {
    ...
    private suspend fun ProtectedAccess.gloryDialogue(type: UnpackedObjType, item: InvObj, invSlot: Int) {
    ...
    private fun ProtectedAccess.gloryPreTeleport(type: UnpackedObjType, item: InvObj, selection: CoordGrid, invSlot: Int) {
    ...
    private fun ProtectedAccess.getMessage(item: InvObj): String? =
        when {
            item.isType(amulets_of_glory.amulet_of_glory_6) || item.isType(amulets_of_glory.trail_amulet_of_glory_6) -> "<col=7f007f>Your amulet has five charges left.</col>"
            item.isType(amulets_of_glory.amulet_of_glory_5) || item.isType(amulets_of_glory.trail_amulet_of_glory_5) -> "<col=7f007f>Your amulet has four charges left.</col>"
            item.isType(amulets_of_glory.amulet_of_glory_4) || item.isType(amulets_of_glory.trail_amulet_of_glory_4) -> "<col=7f007f>Your amulet has three charges left.</col>"
            item.isType(amulets_of_glory.amulet_of_glory_3) || item.isType(amulets_of_glory.trail_amulet_of_glory_3) -> "<col=7f007f>Your amulet has two charges left.</col>"
            item.isType(amulets_of_glory.amulet_of_glory_2) || item.isType(amulets_of_glory.trail_amulet_of_glory_2) -> "<col=7f007f>Your amulet has one charge left.</col>"
            item.isType(amulets_of_glory.amulet_of_glory_1) || item.isType(amulets_of_glory.trail_amulet_of_glory_1) -> "<col=7f007f>Your amulet has run out of charges.</col>"
