...
object BaseVarps : VarpReferences() {
    ...
    val tracking_food_eaten = find("tracking_food_eaten")
    val tracking_potions_sipped = find("tracking_potions_sipped")
    val tracking_secondary_heal = find("tracking_secondary_heal")
